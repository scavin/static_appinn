...
$(document).ready(function(){
  ...
  $('#topnav ul li').hover(function(){$('#topnav ul li').removeClass('current_page_item');$('#topnav ul li').removeClass('current');$(this).attr('class','current').children('ul').css('opacity','0.85').slideDown(100)},function(){$(this).addClass('current').children('ul').slideUp(200)} );
